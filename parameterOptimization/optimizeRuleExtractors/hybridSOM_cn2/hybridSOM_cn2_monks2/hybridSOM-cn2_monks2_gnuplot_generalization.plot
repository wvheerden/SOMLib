set output "hybridSOM-cn2_monks2_gnuplot_generalization.tex"
set size 1.8,1
...
plot [0:9] "1_generalization_hybridSOM-cn2_monks2.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
            "1_generalization_hybridSOM-cn2_monks2.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"