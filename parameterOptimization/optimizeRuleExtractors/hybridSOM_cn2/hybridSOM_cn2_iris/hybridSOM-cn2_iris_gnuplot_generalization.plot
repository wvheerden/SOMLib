set output "hybridSOM-cn2_iris_gnuplot_generalization.tex"
set size 1.8,1
...
set label "{\\centering\\scriptsize$\\mathsf{5.333}$}" at 8,-0.025 front
...
set label "{\\centering\\scriptsize$\\mathsf{75.333}$}" at 8,1.025 front
set label "{\\centering\\scriptsize$\\mathsf{15.067}$}" at 9,1.025 front
...
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00}8.301}$}" at 0.752,0.815078125 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;}635.742}$}" at 1.752,0.41182812500067 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00}4.711}$}" at 2.752,0.37257812558333 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}18.164}$}" at 3.752,0.16964062501 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;000.}123}$}" at 5.752,0.62206532663317 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}51.953}$}" at 6.752,0.251765625 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}34.000}$}" at 7.752,0.42352380952381 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00}2.000}$}" at 8.752,0.06309004739336 front

plot [0:9] "1_generalization_hybridSOM-cn2_iris.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
            "1_generalization_hybridSOM-cn2_iris.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"
