set output "hybridSOM-cn2_monks1_gnuplot_generalization.tex"
set size 1.8,1
...
set label "{\\centering\\scriptsize$\\mathsf{29.762}$}" at 8,-0.025 front
...
set label "{\\centering\\scriptsize$\\mathsf{59.286}$}" at 8,1.025 front
set label "{\\centering\\scriptsize$\\mathsf{58.700}$}" at 9,1.025 front
...
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0000.}13}$}" at -0.248,0.61111111111111 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00}0.410}$}" at 0.752,0.036015625 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}38.086}$}" at 2.119,0.02039062500067 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}11.096}$}" at 2.752,0.560785156345 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}50.195}$}" at 3.752,0.482953125 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0000.}68}$}" at 5.752,0.33668341708543 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;}125.391}$}" at 6.752,0.637953125 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}46.429}$}" at 7.752,0.54751612903226 front

plot [0:9] "1_generalization_hybridSOM-cn2_monks1.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
            "1_generalization_hybridSOM-cn2_monks1.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"