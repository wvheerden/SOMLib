set output "hybridSOM-cn2_pima_gnuplot_generalization.tex"
set size 1.8,1
...
set label "{\\centering\\scriptsize$\\mathsf{29.200}$}" at 8,-0.025 front
...
set label "{\\centering\\scriptsize$\\mathsf{66.267}$}" at 8,1.025 front
set label "{\\centering\\scriptsize$\\mathsf{127.500}$}" at 9,1.025 front
...
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00000.}3}$}" at -0.248,0.04 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00}9.668}$}" at 0.742,0.966796875 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;}407.227}$}" at 1.752,0.25748437500067 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00}2.104}$}" at 2.752,0.06290798614431 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}24.805}$}" at 3.752,0.26304687501 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;000.}165}$}" at 5.752,0.83112060301508 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00}4.297}$}" at 6.737,0.021484375 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}30.267}$}" at 7.752,0.05077697841727 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00}1.667}$}" at 8.742,0.03327009222661 front

plot [0:9] "1_generalization_hybridSOM-cn2_pima.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
            "1_generalization_hybridSOM-cn2_pima.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"