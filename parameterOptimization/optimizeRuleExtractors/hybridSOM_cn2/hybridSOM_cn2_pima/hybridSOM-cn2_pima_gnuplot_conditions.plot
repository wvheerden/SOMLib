set output "hybridSOM-cn2_pima_gnuplot_conditions.tex"
set size 1.8,1
...
plot [0:9] "3_conditions_hybridSOM-cn2_pima.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
            "3_conditions_hybridSOM-cn2_pima.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"