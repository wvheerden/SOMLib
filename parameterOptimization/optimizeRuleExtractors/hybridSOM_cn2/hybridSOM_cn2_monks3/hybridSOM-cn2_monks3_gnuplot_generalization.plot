set output "hybridSOM-cn2_monks3_gnuplot_generalization.tex"
set size 1.8,1
...
set label "{\\centering\\scriptsize$\\mathsf{12.619}$}" at 8,-0.025 front
...
set label "{\\centering\\scriptsize$\\mathsf{54.048}$}" at 8,1.025 front
set label "{\\centering\\scriptsize$\\mathsf{59.133}$}" at 9,1.025 front
...
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00}0.039}$}" at 0.742,0.01890625 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;}462.891}$}" at 1.752,0.31859375000067 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}11.016}$}" at 2.752,0.56378125045 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}57.422}$}" at 3.752,0.59521875 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;000.}163}$}" at 5.752,0.81807035175879 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}25.781}$}" at 6.752,0.12890625 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}38.333}$}" at 7.752,0.63068965517241 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00}1.733}$}" at 8.742,0.01890625 front

plot [0:9] "1_generalization_hybridSOM-cn2_monks3.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
            "1_generalization_hybridSOM-cn2_monks3.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"