set output "hybridSOM-c4-5_iris_gnuplot_conditions.tex"
set size 2.2,1
...
set arrow 11 from 7.965,0.090909091 to 8.035,0.090909091 nohead front lw 2
set label "{\\centering\\scriptsize $\\mathsf{\\phantom{0\\;0000}0.0}$}" at 7.700,0.090909091 front	# x is usually 2.720
...
set label "{\\centering\\scriptsize$\\mathsf{100.0}$}" at 7,1.025 front
set label "{\\centering\\scriptsize$\\mathsf{100.0}$}" at 8,1.025 front
set label "{\\centering\\scriptsize$\\mathsf{10\\;000.0}$}" at 9,1.025 front
...
set label "{\\centering\\small\\textsf{\\phantom{p}}${\\cal E}_{FT}$\\textsf{\\phantom{p}}}" at 11,1.08 front

# optimal value labels
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00000.}8}$}" at -0.268,0.6 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00}4.297}$}" at 0.732,0.4166875 front
set label "{\\scriptsize $\\mathsf{1\\;089.844}$}" at 1.732,0.7365625 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00}5.438}$}" at 2.732,0.44612500025 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}86.719}$}" at 3.732,0.8741875 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0000.}15}$}" at 4.732,0.0929020979021 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}24.219}$}" at 6.732,0.2421875 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;}234.375}$}" at 8.732,0.0414375 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}14.667}$}" at 9.732,0.17416216216216 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00}4.733}$}" at 10.732,0.64236363636364 front

plot [0:11] "3_conditions_hybridSOM-c4-5_iris.error.summary" index 1:101 using 1:2 with lines linetype 1 linewidth 5 linecolor rgb "#cccccc",\
            "3_conditions_hybridSOM-c4-5_iris.error.summary" index 0 using 1:2 with lines linetype 2 dashtype 3 linewidth 6 linecolor rgb "#000000"
