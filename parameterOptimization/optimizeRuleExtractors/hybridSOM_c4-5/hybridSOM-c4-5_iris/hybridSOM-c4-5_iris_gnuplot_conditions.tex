...
\begin{picture}(15840.00,5040.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(12958,-124){\makebox(0,0){\centering\scriptsize$\mathsf{0.0}$}}%
      \put(14397,-124){\makebox(0,0){\centering\scriptsize$\mathsf{2.667}$}}%
      \put(15837,-124){\makebox(0,0){\centering\scriptsize$\mathsf{1.000}$}}%
      \put(11086,458){\makebox(0,0){\centering\scriptsize $\mathsf{\phantom{0\;0000}0.0}$}}%
      \put(0,5165){\makebox(0,0){\centering\scriptsize$\mathsf{12}$}}%
      \put(1440,5165){\makebox(0,0){\centering\scriptsize$\mathsf{10.0}$}}%
      \put(2879,5165){\makebox(0,0){\centering\scriptsize$\mathsf{1\;500.0}$}}%
      \put(4319,5165){\makebox(0,0){\centering\scriptsize$\mathsf{12.0}$}}%
      ...
      \put(10078,5165){\makebox(0,0){\centering\scriptsize$\mathsf{100.0}$}}%
      \put(11518,5165){\makebox(0,0){\centering\scriptsize$\mathsf{100.0}$}}%
      \put(12958,5165){\makebox(0,0){\centering\scriptsize$\mathsf{10\;000.0}$}}%
