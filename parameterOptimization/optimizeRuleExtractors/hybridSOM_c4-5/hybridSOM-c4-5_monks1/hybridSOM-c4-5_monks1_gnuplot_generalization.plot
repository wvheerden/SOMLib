set output "hybridSOM-c4-5_monks1_gnuplot_generalization.tex"
set size 2.2,1
...
set label "{\\centering\\scriptsize$\\mathsf{24.286}$}" at 10,-0.025 front
...
set label "{\\centering\\scriptsize $\\mathsf{\\phantom{0\\;00}0.000}$}" at 7.650,0.090909091 front	# x is usually 2.720
...
set label "{\\centering\\scriptsize$\\mathsf{59.762}$}" at 10,1.025 front
set label "{\\centering\\scriptsize$\\mathsf{12.400}$}" at 11,1.025 front
...
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00}9.043}$}" at 0.752,0.887296875 front
set label "{\\scriptsize $\\mathsf{1\\;438.477}$}" at 1.752,0.974984375 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}10.273}$}" at 2.752,0.503671875485 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}43.555}$}" at 3.752,0.41354687501 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;000.}106}$}" at 4.752,0.247515789473684 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}88.867}$}" at 6.752,0.868671875 front
set label "{\\scriptsize $\\mathsf{3\\;769.531}$}" at 8.752,0.388953125 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}37.857}$}" at 9.752,0.40555033670108 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00}1.933}$}" at 10.752,0.07087134502924 front

plot [0:11] "1_generalization_hybridSOM-c4-5_monks1.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
            "1_generalization_hybridSOM-c4-5_monks1.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"