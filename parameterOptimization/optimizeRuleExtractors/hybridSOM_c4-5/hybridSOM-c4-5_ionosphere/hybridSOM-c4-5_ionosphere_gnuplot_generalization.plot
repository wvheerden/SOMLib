set output "hybridSOM-c4-5_ionosphere_gnuplot_generalization.tex"
set size 2.2,1
...
set label "{\\centering\\scriptsize$\\mathsf{13.939}$}" at 10,-0.025 front
...
set label "{\\centering\\scriptsize $\\mathsf{\\phantom{0\\;00}0.000}$}" at 8.107,0.090909091 front	# x is usually 2.720
...
set label "{\\centering\\scriptsize$\\mathsf{324}$}" at 5,1.025 front
...
set label "{\\centering\\scriptsize$\\mathsf{63.939}$}" at 10,1.025 front
set label "{\\centering\\scriptsize$\\mathsf{18.733}$}" at 11,1.025 front
...
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00000.}7}$}" at -0.248,0.3125 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00}8.965}$}" at 0.752,0.905484375 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;}676.758}$}" at 1.752,0.44317187500067 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00}3.322}$}" at 2.752,0.17457031270556 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}30.273}$}" at 3.752,0.31773437501 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0000.}12}$}" at 4.752,0.02405572755418 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}34.961}$}" at 6.752,0.349609375 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;}722.656}$}" at 8.752,0.091265625 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}20.000}$}" at 9.752,0.14289610337415 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00}3.133}$}" at 10.752,0.1438951048951 front

plot [0:11] "1_generalization_hybridSOM-c4-5_ionosphere.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
            "1_generalization_hybridSOM-c4-5_ionosphere.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"