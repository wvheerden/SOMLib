set output "c4-5_monks1_gnuplot_generalization.tex"
set size 1.2,1
...
set label "{\\centering\\scriptsize$\\mathsf{75.000}$}" at 5,1.025 front
set label "{\\centering\\scriptsize$\\mathsf{31.833}$}" at 6,1.025 front
...
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0000.}93}$}" at -0.248,0.22062350119904 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}43.945}$}" at 1.752,0.427453125 front
set label "{\\scriptsize $\\mathsf{1\\;972.656}$}" at 3.752,0.210265625 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}24.286}$}" at 4.752,0.33880952619321 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00}3.000}$}" at 5.752,0.05586486486486 front

plot [0:6] "1_generalization_c4-5_monks1.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
           "1_generalization_c4-5_monks1.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"