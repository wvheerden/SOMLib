set output "c4-5_monks3_gnuplot_generalization.tex"
set size 1.2,1
...
set label "{\\centering\\scriptsize $\\mathsf{\\phantom{0\\;00}0.000}$}" at 3.107,0.090909091 front	# x is usually 2.720

# parallel axis upper label values
set label "{\\centering\\scriptsize$\\mathsf{418}$}" at 0,1.025 front
...
set label "{\\centering\\scriptsize$\\mathsf{50.714}$}" at 5,1.025 front
set label "{\\centering\\scriptsize$\\mathsf{40.833}$}" at 6,1.025 front
...
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0000.}56}$}" at -0.248,0.13189448441247 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}92.969}$}" at 1.752,0.9126875 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00}1.563}$}" at 2.722,0.11511363636364 front
set label "{\\scriptsize $\\mathsf{3\\;515.625}$}" at 3.752,0.3635625 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00}2.857}$}" at 4.752,0.04133802755101 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00}5.000}$}" at 5.752,0.11941841004184 front

plot [0:6] "1_generalization_c4-5_monks3.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
           "1_generalization_c4-5_monks3.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"