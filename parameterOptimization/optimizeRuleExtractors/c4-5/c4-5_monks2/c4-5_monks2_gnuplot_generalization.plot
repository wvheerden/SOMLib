set output "c4-5_monks2_gnuplot_generalization.tex"
set size 1.2,1
...
set label "{\\centering\\scriptsize$\\mathsf{2.143}$}" at 5,-0.025 front
...
set label "{\\centering\\scriptsize$\\mathsf{38.333}$}" at 5,1.025 front
set label "{\\centering\\scriptsize$\\mathsf{184.800}$}" at 6,1.025 front
...
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0000.}11}$}" at -0.248,0.02398081534772 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}82.031}$}" at 1.752,0.8103125 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}67.188}$}" at 2.752,0.68570454545455 front
set label "{\\scriptsize $\\mathsf{6\\;484.375}$}" at 3.752,0.6290375 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}32.381}$}" at 4.752,0.8486842112949 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}56.600}$}" at 5.752,0.2985027203482 front

plot [0:6] "1_generalization_c4-5_monks2.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
           "1_generalization_c4-5_monks2.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"