set output "sig_pima_gnuplot_generalization.tex"
set size 2.2,1
...
plot [0:12] "1_generalization_sig_pima.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
            "1_generalization_sig_pima.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"