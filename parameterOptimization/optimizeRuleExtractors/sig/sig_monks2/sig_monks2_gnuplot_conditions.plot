set output "sig_monks2_gnuplot_conditions.tex"
set size 2.2,1
...
plot [0:12] "3_conditions_sig_monks2.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
            "3_conditions_sig_monks2.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"