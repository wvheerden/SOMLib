set output "cn2_pima_gnuplot_generalization.tex"
set size 0.8,1
...
set label "{\\centering\\scriptsize$\\mathsf{26.667}$}" at 3,-0.025 front
...
set label "{\\centering\\scriptsize$\\mathsf{37.467}$}" at 3,1.025 front
set label "{\\centering\\scriptsize$\\mathsf{491.733}$}" at 4,1.025 front
...
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;000.}140}$}" at 0.752,0.69349246231156 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;}103.906}$}" at 1.752,0.50853125 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00}2.933}$}" at 3.752,0.02531914893617 front

plot [0:4] "1_generalization_cn2_pima.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
           "1_generalization_cn2_pima.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"