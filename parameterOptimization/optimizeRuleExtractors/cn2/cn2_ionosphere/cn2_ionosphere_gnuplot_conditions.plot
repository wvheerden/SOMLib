set output "cn2_ionosphere_gnuplot_conditions.tex"
set size 0.8,1
...
plot [0:4] "3_conditions_cn2_ionosphere.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
           "3_conditions_cn2_ionosphere.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"