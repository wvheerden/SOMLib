set output "cn2_monks3_gnuplot_generalization.tex"
set size 0.8,1
...
set label "{\\centering\\scriptsize$\\mathsf{2.619}$}" at 3,-0.025 front
...
set label "{\\centering\\scriptsize$\\mathsf{47.381}$}" at 3,1.025 front
set label "{\\centering\\scriptsize$\\mathsf{158.933}$}" at 4,1.025 front
...
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;000.}196}$}" at 0.752,0.96089949748744 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;}160.156}$}" at 1.752,0.79078125 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00}2.857}$}" at 2.735,0.01531914893617 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00}3.000}$}" at 3.752,0.03366357112706 front

plot [0:4] "1_generalization_cn2_monks3.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
           "1_generalization_cn2_monks3.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"