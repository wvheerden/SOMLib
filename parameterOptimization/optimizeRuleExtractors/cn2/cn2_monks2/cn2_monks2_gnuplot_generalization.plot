set output "cn2_monks2_gnuplot_generalization.tex"
set size 0.8,1
...
set label "{\\centering\\scriptsize$\\mathsf{2.143}$}" at 3,-0.025 front
...
set label "{\\centering\\scriptsize$\\mathsf{33.333}$}" at 3,1.025 front
set label "{\\centering\\scriptsize$\\mathsf{144.500}$}" at 4,1.025 front
...
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;000.}129}$}" at 0.752,0.63821608040201 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}14.844}$}" at 1.752,0.07021875 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}22.857}$}" at 2.752,0.66412213740458 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}24.667}$}" at 3.752,0.15492450638792 front

plot [0:4] "1_generalization_cn2_monks2.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
           "1_generalization_cn2_monks2.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"