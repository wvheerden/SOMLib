set output "cn2_monks1_gnuplot_generalization.tex"
set size 0.8,1
...
set label "{\\centering\\scriptsize$\\mathsf{60.238}$}" at 3,1.025 front
set label "{\\centering\\scriptsize$\\mathsf{11.333}$}" at 4,1.025 front
...
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0000.}45}$}" at 0.752,0.22110552763819 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;0}69.141}$}" at 1.752,0.359703125 front
set label "{\\scriptsize $\\mathsf{\\phantom{0\\;00}8.000}$}" at 3.752,0.67741935483871 front

plot [0:4] "1_generalization_cn2_monks1.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
           "1_generalization_cn2_monks1.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"