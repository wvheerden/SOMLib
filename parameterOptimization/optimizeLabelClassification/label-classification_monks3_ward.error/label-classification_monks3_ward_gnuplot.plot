set output "label-classification_monks3_ward_gnuplot.tex"
...
set label "{\\centering\\scriptsize$\\mathsf{28.333}$}" at 5,-0.025 front
...
set label "{\\centering\\scriptsize$\\mathsf{53.810}$}" at 5,1.025 front
...
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00}4.492}$}" at 0.752,0.4442 front
set label "{\\scriptsize$\\mathsf{1\\,271.484}$}" at 1.752,0.852656 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,0}10.438}$}" at 2.752,0.5169 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,0}50.391}$}" at 3.752,0.48391 front

plot [0:5] "1_generalization_label-classification_monks3_ward.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
           "1_generalization_label-classification_monks3_ward.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"
