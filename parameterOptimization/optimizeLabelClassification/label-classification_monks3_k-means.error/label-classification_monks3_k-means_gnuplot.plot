set output "label-classification_monks3_k-means_gnuplot.tex"
...
set label "{\\centering\\scriptsize$\\mathsf{27.619}$}" at 5,-0.025 front
...
set label "{\\centering\\scriptsize$\\mathsf{55.238}$}" at 5,1.025 front
...
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,0000.}17}$}" at -0.248,0.833333333 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00}3.164}$}" at 0.752,0.31640625 front
set label "{\\scriptsize$\\mathsf{1\\,119.141}$}" at 1.752,0.74609375 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,0}16.801}$}" at 2.752,0.855039063 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00}1.172}$}" at 3.752,0.01671875 front

plot [0:5] "1_generalization_label-classification_monks3_k-means.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
           "1_generalization_label-classification_monks3_k-means.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"
