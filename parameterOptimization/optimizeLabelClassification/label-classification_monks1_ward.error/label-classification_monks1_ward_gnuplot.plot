set output "label-classification_monks1_ward_gnuplot.tex"
...
set label "{\\centering\\scriptsize$\\mathsf{75.476}$}" at 5,1.025 front
...
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,0000.}16}$}" at -0.248,0.777777778 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00}6.133}$}" at 0.752,0.6033 front
set label "{\\scriptsize$\\mathsf{1\\,330.078}$}" at 1.752,0.898718667 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00}8.563}$}" at 2.752,0.42515 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,0}87.109}$}" at 3.752,0.87709 front

plot [0:5] "1_generalization_label-classification_monks1_ward.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
           "1_generalization_label-classification_monks1_ward.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"
