...
\begingroup
  ...
  \begin{picture}(7200.00,5040.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(7199,5165){\makebox(0,0){\centering\scriptsize$\mathsf{75.476}$}}%
      ...
      \put(1083,3040){\makebox(0,0){\scriptsize$\mathsf{\phantom{0\,00}6.133}$}}%
      \put(2523,4529){\makebox(0,0){\scriptsize$\mathsf{1\,330.078}$}}%
      \put(3962,2142){\makebox(0,0){\scriptsize$\mathsf{\phantom{0\,00}8.563}$}}%
      \put(5402,4420){\makebox(0,0){\scriptsize$\mathsf{\phantom{0\,0}87.109}$}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics{label-classification_monks1_ward_gnuplot}}%
    \gplfronttext
  \end{picture}%
\endgroup
