set output "label-classification_monks2_ward_gnuplot.tex"
...
set label "{\\centering\\scriptsize$\\mathsf{29.524}$}" at 5,-0.025 front
...
set label "{\\centering\\scriptsize$\\mathsf{43.571}$}" at 5,1.025 front
...
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00}2.695}$}" at 0.752,0.26953125 front
set label "{\\scriptsize$\\mathsf{1\\,470.703}$}" at 1.752,0.98046875 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00}0.074}$}" at 2.752,0.016710938 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,0}71.484}$}" at 3.752,0.71484375 front

plot [0:5] "1_generalization_label-classification_monks2_ward.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
           "1_generalization_label-classification_monks2_ward.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"
