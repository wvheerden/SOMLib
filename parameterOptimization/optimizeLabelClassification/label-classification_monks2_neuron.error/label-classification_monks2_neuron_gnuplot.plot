set output "label-classification_monks2_neuron_gnuplot.tex"
...
set label "{\\centering\\scriptsize$\\mathsf{20.238}$}" at 5,-0.025 front
...
set label "{\\centering\\scriptsize$\\mathsf{57.143}$}" at 5,1.025 front
...
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00}8.867}$}" at 0.752,0.89671875 front
set label "{\\scriptsize$\\mathsf{1\\,365.234}$}" at 1.752,0.93015625 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00}1.348}$}" at 2.752,0.067382813 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,0}31.641}$}" at 3.752,0.32540625 front

plot [0:5] "1_generalization_label-classification_monks2_neuron.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
           "1_generalization_label-classification_monks2_neuron.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"
