set output "label-classification_pima_ward_gnuplot.tex"
...
set label "{\\centering\\scriptsize$\\mathsf{24.933}$}" at 5,-0.025 front
...
set label "{\\centering\\scriptsize$\\mathsf{37.600}$}" at 5,1.025 front
...
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00}2.578}$}" at 0.752,0.2478125 front
set label "{\\scriptsize$\\mathsf{1\\,160.156}$}" at 1.752,0.7734375 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00}8.719}$}" at 2.752,0.322916667 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,0}88.281}$}" at 3.752,0.8828125 front

plot [0:5] "1_generalization_label-classification_pima_ward.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
           "1_generalization_label-classification_pima_ward.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"
