set output "label-classification_iris_ward_gnuplot.tex"
...
set label "{\\centering\\scriptsize$\\mathsf{18.000}$}" at 5,-0.025 front
...
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00000.}9}$}" at -0.248,0.7 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00}4.180}$}" at 0.752,0.41296875 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00}5.859}$}" at 1.702,0.02 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00}8.402}$}" at 2.752,0.708195313 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,0}66.016}$}" at 3.752,0.64515625 front

plot [0:5] "1_generalization_label-classification_iris_ward.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
           "1_generalization_label-classification_iris_ward.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"
