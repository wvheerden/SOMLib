set output "label-classification_ionosphere_k-means_gnuplot.tex"
...
set label "{\\centering\\scriptsize$\\mathsf{9.394}$}" at 5,-0.025 front
...
set label "{\\centering\\scriptsize$\\mathsf{37.273}$}" at 5,1.025 front
...
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00}1.953}$}" at 0.752,0.1923125 front
set label "{\\scriptsize$\\mathsf{1\\,253.906}$}" at 1.752,0.8459375 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00}7.453}$}" at 2.752,0.4080625006 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,0}82.031}$}" at 3.752,0.8303125 front

plot [0:5] "1_generalization_label-classification_ionosphere_k-means.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
           "1_generalization_label-classification_ionosphere_k-means.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"
