set output "label-classification_ionosphere_ward_gnuplot.tex"
...
set label "{\\centering\\scriptsize$\\mathsf{8.182}$}" at 5,-0.025 front
...
set label "{\\centering\\scriptsize$\\mathsf{36.061}$}" at 5,1.025 front
...
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,0000.}15}$}" at -0.248,0.81250000000000 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00}2.148}$}" at 0.752,0.20784375000000 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,}638.672}$}" at 1.752,0.44078125000038 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00}2.520}$}" at 2.752,0.12797395902669 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,0}64.453}$}" at 3.752,0.65453125000355 front

plot [0:5] "1_generalization_label-classification_ionosphere_ward.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
           "1_generalization_label-classification_ionosphere_ward.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"
