set output "label-classification_monks3_weight-centric_gnuplot.tex"
...
set label "{\\centering\\scriptsize$\\mathsf{57.381}$}" at 5,1.025 front
...
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00}9.629}$}" at 0.752,0.937890625 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,0}61.523}$}" at 1.752,0.041015625 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00}4.639}$}" at 2.752,0.241933594 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,0}67.383}$}" at 3.752,0.678828125 front

plot [0:5] "1_generalization_label-classification_monks3_weight-centric.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
           "1_generalization_label-classification_monks3_weight-centric.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"
