...
\begingroup
  ...
  \begin{picture}(7200.00,5040.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(7199,5165){\makebox(0,0){\centering\scriptsize$\mathsf{57.381}$}}%
      ...
      \put(1083,4726){\makebox(0,0){\scriptsize$\mathsf{\phantom{0\,00}9.629}$}}%
      \put(2523,207){\makebox(0,0){\scriptsize$\mathsf{\phantom{0\,0}61.523}$}}%
      \put(3962,1219){\makebox(0,0){\scriptsize$\mathsf{\phantom{0\,00}4.639}$}}%
      \put(5402,3421){\makebox(0,0){\scriptsize$\mathsf{\phantom{0\,0}67.383}$}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics{label-classification_monks3_weight-centric_gnuplot}}%
    \gplfronttext
  \end{picture}%
\endgroup
