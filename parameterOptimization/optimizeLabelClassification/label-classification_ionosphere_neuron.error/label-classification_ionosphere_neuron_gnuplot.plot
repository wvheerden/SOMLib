set output "label-classification_ionosphere_neuron_gnuplot.tex"
...
set label "{\\centering\\scriptsize$\\mathsf{11.515}$}" at 5,-0.025 front
...
set label "{\\centering\\scriptsize$\\mathsf{40.000}$}" at 5,1.025 front
...
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00}3.848}$}" at 0.752,0.402765625 front
set label "{\\scriptsize$\\mathsf{1\\,209.961}$}" at 1.752,0.816640625 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00}1.818}$}" at 2.752,0.0960199656 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,0}59.570}$}" at 3.752,0.605703125 front

plot [0:5] "1_generalization_label-classification_ionosphere_neuron.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
           "1_generalization_label-classification_ionosphere_neuron.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"
