set output "label-classification_pima_neuron_gnuplot.tex"
...
set label "{\\centering\\scriptsize$\\mathsf{26.133}$}" at 5,-0.025 front
...
set label "{\\centering\\scriptsize$\\mathsf{51.733}$}" at 5,1.025 front
...
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,0000.}12}$}" at -0.248,0.4 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00}2.070}$}" at 0.752,0.197 front
set label "{\\scriptsize$\\mathsf{1\\,376.953}$}" at 1.752,0.917968667 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00}9.797}$}" at 2.752,0.358851852 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,0}52.734}$}" at 3.752,0.54034 front

plot [0:5] "1_generalization_label-classification_pima_neuron.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
           "1_generalization_label-classification_pima_neuron.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"
