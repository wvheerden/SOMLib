set output "label-classification_monks1_neuron_gnuplot.tex"
...
set label "{\\centering\\scriptsize$\\mathsf{20.000}$}" at 5,-0.025 front
...
set label "{\\centering\\scriptsize$\\mathsf{79.286}$}" at 5,1.025 front
...
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,0000.}14}$}" at -0.248,0.666666672 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00}6.055}$}" at 0.752,0.59046875 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,}849.609}$}" at 1.752,0.55140625 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,0}10.445}$}" at 2.752,0.507265625 front
set label "{\\scriptsize$\\mathsf{\\phantom{0\\,00}9.766}$}" at 3.752,0.09765625 front

plot [0:5] "1_generalization_label-classification_monks1_neuron.error.summary" index 1:101 using 1:2 with lines linetype 1 linecolor rgb "#c1c1c1",\
           "1_generalization_label-classification_monks1_neuron.error.summary" index 0 using 1:2 with lines linetype 2 linewidth 3 linecolor rgb "#000000"
