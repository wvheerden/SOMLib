set output "iris_testMisclassifiedError.tex"
...
set yrange [-6.50696115995227409:43.19794810497234749]
plot "iris_testMisclassifiedError.txt" using 1:2:3 ps 2.5 with errorbars
