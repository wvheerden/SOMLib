set output "monks1_trainingMisclassifiedError.tex"
...
set ylabel "\\small\\textsf{Training error (misclassified)}" offset 3.25
...
set yrange [16.37460006077368746:31.05800416921417906]
plot "monks1_trainingMisclassifiedError.txt" using 1:2:3 ps 2.5 with errorbars
