set output "monks1_testUnclassifiedError.tex"
...
set yrange [-2.46282696825172831:4.81509839010235030]
plot "monks1_testUnclassifiedError.txt" using 1:2:3 ps 2.5 with errorbars
