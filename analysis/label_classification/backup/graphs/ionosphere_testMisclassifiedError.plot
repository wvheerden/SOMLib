set output "ionosphere_testMisclassifiedError.tex"
...
set yrange [-1.97628382999238572:28.55559228875392108]
plot "ionosphere_testMisclassifiedError.txt" using 1:2:3 ps 2.5 with errorbars
