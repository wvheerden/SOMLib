set output "ionosphere_percentageUnlabeled.tex"
...
set ylabel "\\small\\textsf{Percentage unlabeled neurons}" offset screen 0.1
...
set yrange [-0.28609888497737851:6.00807658452494842]
plot "ionosphere_percentageUnlabeled.txt" using 1:2:3 ps 2.5 with errorbars
