set output "monks2_trainingUnclassifiedError.tex"
...
set ylabel "\\small\\textsf{Training error (unclassified)}" offset screen 0.1
...
set yrange [-3:3]
plot "monks2_trainingUnclassifiedError.txt" using 1:2:3 ps 2.5 with errorbars
