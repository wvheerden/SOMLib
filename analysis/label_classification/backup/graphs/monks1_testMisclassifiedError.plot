set output "monks1_testMisclassifiedError.tex"
...
set yrange [4.63908677707084482:47.40873415592572826]
plot "monks1_testMisclassifiedError.txt" using 1:2:3 ps 2.5 with errorbars
