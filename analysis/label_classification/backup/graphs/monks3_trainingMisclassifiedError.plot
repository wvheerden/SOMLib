set output "monks3_trainingMisclassifiedError.tex"
...
set yrange [17.34600854585237784:29.44706648247151648]
plot "monks3_trainingMisclassifiedError.txt" using 1:2:3 ps 2.5 with errorbars
