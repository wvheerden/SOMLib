set output "monks3_percentageUnlabeled.tex"
...
set yrange [-1.88331955416593866:39.54971063748470783]
plot "monks3_percentageUnlabeled.txt" using 1:2:3 ps 2.5 with errorbars
