set output "pima_trainingMisclassifiedError.tex"
...
set yrange [19.26956677196342937:26.90996871022160164]
plot "pima_trainingMisclassifiedError.txt" using 1:2:3 ps 2.5 with errorbars
