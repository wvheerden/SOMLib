set output "monks2_testUnclassifiedError.tex"
...
set yrange [-1.68315310212152802:3.11172453072152777]
plot "monks2_testUnclassifiedError.txt" using 1:2:3 ps 2.5 with errorbars
