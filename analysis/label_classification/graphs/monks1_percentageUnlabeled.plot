set output "monks1_percentageUnlabeled.tex"
...
set yrange [-2.32673572932198125:48.86145031576160846]
plot "monks1_percentageUnlabeled.txt" using 1:2:3 ps 2.5 with errorbars
