set output "pima_testUnclassifiedError.tex"
...
set yrange [-1.00114902920692095:2.33448236254025421]
plot "pima_testUnclassifiedError.txt" using 1:2:3 ps 2.5 with errorbars
