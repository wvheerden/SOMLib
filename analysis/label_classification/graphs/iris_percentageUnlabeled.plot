set output "iris_percentageUnlabeled.tex"
...
set yrange [-6.45745944442265341:29.42042240738561887]
plot "iris_percentageUnlabeled.txt" using 1:2:3 ps 2.5 with errorbars
