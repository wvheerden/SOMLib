set output "iris_trainingMisclassifiedError.tex"
...
set yrange [0.20677895757793552:36.90386102432312043]
plot "iris_trainingMisclassifiedError.txt" using 1:2:3 ps 2.5 with errorbars
