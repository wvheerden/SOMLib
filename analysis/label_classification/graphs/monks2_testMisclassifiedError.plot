set output "monks2_testMisclassifiedError.tex"
...
set yrange [8.67690570375389925:45.41998410475970616]
plot "monks2_testMisclassifiedError.txt" using 1:2:3 ps 2.5 with errorbars
