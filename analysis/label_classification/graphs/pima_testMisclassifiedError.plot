set output "pima_testMisclassifiedError.tex"
...
set yrange [14.40475927053423000:39.15686112741645530]
plot "pima_testMisclassifiedError.txt" using 1:2:3 ps 2.5 with errorbars
