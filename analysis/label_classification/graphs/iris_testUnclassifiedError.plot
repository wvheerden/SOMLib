set output "iris_testUnclassifiedError.tex"
...
set yrange [-3.34996542170455225:4.68329875503788617]
plot "iris_testUnclassifiedError.txt" using 1:2:3 ps 2.5 with errorbars
