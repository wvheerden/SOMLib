set output "monks2_percentageUnlabeled.tex"
...
set yrange [-2.58463923277565044:54.27742388828865217]
plot "monks2_percentageUnlabeled.txt" using 1:2:3 ps 2.5 with errorbars
