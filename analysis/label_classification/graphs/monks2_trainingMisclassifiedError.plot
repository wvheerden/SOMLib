set output "monks2_trainingMisclassifiedError.tex"
...
set yrange [14.18114427968073876:34.58461649689247963]
plot "monks2_trainingMisclassifiedError.txt" using 1:2:3 ps 2.5 with errorbars
