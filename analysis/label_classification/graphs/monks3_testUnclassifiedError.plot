set output "monks3_testUnclassifiedError.tex"
...
set yrange [-1.51723055861458711:2.46961151099553922]
plot "monks3_testUnclassifiedError.txt" using 1:2:3 ps 2.5 with errorbars
