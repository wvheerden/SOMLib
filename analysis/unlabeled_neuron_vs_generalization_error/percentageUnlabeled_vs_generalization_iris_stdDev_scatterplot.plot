...
set output "percentageUnlabeled_vs_generalization_iris_stdDev_scatterplot.eps"
...
#set bmargin 0
set size 1, 0.75
plot "label-classification_iris_neuron.error.summary.separated" using 12:9 with points title ""