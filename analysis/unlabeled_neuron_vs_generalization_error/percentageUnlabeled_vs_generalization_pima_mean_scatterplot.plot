...
set output "percentageUnlabeled_vs_generalization_pima_mean_scatterplot.eps"
...
#set bmargin 0
set size 1, 0.75
plot "label-classification_pima_neuron.error.summary.separated" using 12:8 with points title ""