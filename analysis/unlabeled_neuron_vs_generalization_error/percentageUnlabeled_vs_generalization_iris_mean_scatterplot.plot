...
set output "percentageUnlabeled_vs_generalization_iris_mean_scatterplot.eps"
...
#set bmargin 0
set size 1, 0.75
plot "label-classification_iris_neuron.error.summary.separated" using 12:8 with points title ""