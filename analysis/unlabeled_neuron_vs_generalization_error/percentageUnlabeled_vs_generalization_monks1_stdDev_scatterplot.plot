...
set output "percentageUnlabeled_vs_generalization_monks1_stdDev_scatterplot.eps"
...
#set bmargin 0
set size 1, 0.75
plot "label-classification_monks1_neuron.error.summary.separated" using 12:9 with points title ""