set output "pima_trainingUnclassifiedError.tex"
...
set yrange [-0.15079021057393016:3.16659442205253328]
plot "pima_trainingUnclassifiedError.txt" using 1:2:3 with errorbars
