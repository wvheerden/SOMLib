set output "iris_ruleSetConditionCount.tex"
...
set yrange [1.29999999999999982:16.69999999999999929]
plot "iris_ruleSetConditionCount.txt" using 1:2:3 with errorbars
