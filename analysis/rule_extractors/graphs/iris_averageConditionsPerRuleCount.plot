set output "iris_averageConditionsPerRuleCount.tex"
...
set yrange [0.64999999999999991:8.34999999999999964]
plot "iris_averageConditionsPerRuleCount.txt" using 1:2:3 with errorbars
