set output "monks1_ruleSetConditionCount.tex"
...
set yrange [-103.03329216046036265:2183.90615311318379099]
plot "monks1_ruleSetConditionCount.txt" using 1:2:3 with errorbars
