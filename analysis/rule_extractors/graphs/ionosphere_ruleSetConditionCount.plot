set output "ionosphere_ruleSetConditionCount.tex"
...
set ylabel "\\small\\textsf{Total conditions in rule set}" offset 3.25
...
set yrange [-103.29173342151592863:2210.65703633216526214]
plot "ionosphere_ruleSetConditionCount.txt" using 1:2:3 with errorbars
