set output "monks1_averageConditionsPerRuleCount.tex"
...
set yrange [-0.12360661406427376:24.59573889534974711]
plot "monks1_averageConditionsPerRuleCount.txt" using 1:2:3 with errorbars
