set output "monks2_ruleSetConditionCount.tex"
...
set yrange [-2.14779867056443496:67.10377208185313691]
plot "monks2_ruleSetConditionCount.txt" using 1:2:3 with errorbars
