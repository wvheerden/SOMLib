set output "monks1_trainingUnclassifiedError.tex"
...
set yrange [-0.06644818429267828:1.39541187014624390]
plot "monks1_trainingUnclassifiedError.txt" using 1:2:3 with errorbars
