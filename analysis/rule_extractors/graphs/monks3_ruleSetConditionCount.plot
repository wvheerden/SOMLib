set output "monks3_ruleSetConditionCount.tex"
...
set yrange [-106.26066470467060299:2248.04146134585926120]
plot "monks3_ruleSetConditionCount.txt" using 1:2:3 with errorbars
