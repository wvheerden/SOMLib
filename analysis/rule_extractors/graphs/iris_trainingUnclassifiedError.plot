set output "iris_trainingUnclassifiedError.tex"
...
set yrange [-0.83345255647936600:17.50250368606668516]
plot "iris_trainingUnclassifiedError.txt" using 1:2:3 with errorbars
