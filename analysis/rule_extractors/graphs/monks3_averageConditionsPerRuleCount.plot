set output "monks3_averageConditionsPerRuleCount.tex"
...
set yrange [-3.27673731651412137:89.45335928374069567]
plot "monks3_averageConditionsPerRuleCount.txt" using 1:2:3 with errorbars
