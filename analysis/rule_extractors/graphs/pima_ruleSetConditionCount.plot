set output "pima_ruleSetConditionCount.tex"
...
set yrange [-20.97317728375234580:463.76086405847718197]
plot "pima_ruleSetConditionCount.txt" using 1:2:3 with errorbars
