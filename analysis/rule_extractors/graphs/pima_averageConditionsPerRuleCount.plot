set output "pima_averageConditionsPerRuleCount.tex"
...
set yrange [-0.46505581741038182:29.44149183423197869]
plot "pima_averageConditionsPerRuleCount.txt" using 1:2:3 with errorbars
