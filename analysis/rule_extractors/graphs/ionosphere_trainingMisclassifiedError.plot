set output "ionosphere_trainingMisclassifiedError.tex"
...
set yrange [4.61296589983903615:26.19877239652928935]
plot "ionosphere_trainingMisclassifiedError.txt" using 1:2:3 with errorbars
