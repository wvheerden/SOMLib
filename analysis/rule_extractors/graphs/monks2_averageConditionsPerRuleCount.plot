set output "monks2_averageConditionsPerRuleCount.tex"
...
set yrange [-0.65000000000000013:35.64999999999999858]
plot "monks2_averageConditionsPerRuleCount.txt" using 1:2:3 with errorbars
