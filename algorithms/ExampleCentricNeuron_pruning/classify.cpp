...
int main(int argc, char** argv) {
	...
	try {
		...
		// prune interpolating units
		std::cout << "Pruning interpolating units...";
		readMap->markInterpolatingUnits(atof(argv[7]));
		std::cout << " Done" << std::endl;
		
		// label map
		std::cout << "Labeling map vectors...";
		readMap->neuronCentricLabelMap(trainingDataReader);
		std::cout << " Done" << std::endl;
		...
		outputAccuracyWriter << readMap->getTrainingAccuracy() << "\t" << "0.000000000000000"                      << "\t" << "0.000000000000000"                     << "\t" << readMap->getTestAccuracy() << "\t" << "0.000000000000000"                  << "\t" << "0.000000000000000"                 << "\t" << readMap->getUnlabeledWeights() << "\t" << readMap->getUnlabeledWeightPercentage() << "\t" << readMap->getPrunedNeuronCount() << "\t" << readMap->getPrunedNeuronPercentage() << "\t" << readMap->getUnprunedNeuronCount() << "\t" << readMap->getUnprunedNeuronPercentage() << std::endl;
		outputAccuracyWriter.close();
		outputErrorWriter    << readMap->getTrainingError()    << "\t" << readMap->getTrainingMisclassifiedError() << "\t" << readMap->getTrainingUnclassifiedError() << "\t" << readMap->getTestError()    << "\t" << readMap->getTestMisclassifiedError() << "\t" << readMap->getTestUnclassifiedError() << "\t" << readMap->getUnlabeledWeights() << "\t" << readMap->getUnlabeledWeightPercentage() << "\t" << readMap->getPrunedNeuronCount() << "\t" << readMap->getPrunedNeuronPercentage() << "\t" << readMap->getUnprunedNeuronCount() << "\t" << readMap->getUnprunedNeuronPercentage() << std::endl;
