...
class SOMMap {
	...
	public:
		...
		unsigned int getPrunedNeuronCount() const;
		double getPrunedNeuronPercentage() const;
		unsigned int getUnprunedNeuronCount() const;
		double getUnprunedNeuronPercentage() const;
	...
	private:
		...
		unsigned int unprunedNeuronCount;
