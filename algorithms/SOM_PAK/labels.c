...
int
set_entry_label (struct data_entry *entry, int label)
{
...
int
get_entry_labels (struct data_entry *entry, int i)
{
...
void
clear_entry_labels (struct data_entry *entry)
{
	if (entry->num_labs > 1)
...
int
add_entry_label (struct data_entry *entry, int label)
{
	int *atable = NULL;
...
int
copy_entry_labels (struct data_entry *dest, struct data_entry *source)
{
...
void
clear_hitlist (struct hitlist *hl)
{
...
void
free_hitlist (struct hitlist *hl)
{
	if (hl) {
...
struct hit_entry *
find_hit (struct hitlist *hl, long label)
{
	struct hit_entry *he;
...
static struct hit_entry *
hit_swapwprev (struct hitlist *hl, struct hit_entry *he)
{
...
long
add_hit (struct hitlist *hl, long label)
{
	struct hit_entry *he;
...
void
print_hitlist (struct hitlist *hl, FILE * fp)
{
	struct hit_entry *he;
	int lab;
...
long
hitlist_label_freq (struct hitlist *hl, long label)
{
	struct hit_entry *he;
