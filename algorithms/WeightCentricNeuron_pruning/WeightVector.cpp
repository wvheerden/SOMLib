...
vectorDimension(_vectorDimension), weights(new double[_vectorDimension]), label(""), averageNeighbourDistance(0.0), toBePruned(false) {
...
vectorDimension(source.vectorDimension), weights(new double[source.vectorDimension]), hitCounts(source.hitCounts), label(source.label), averageNeighbourDistance(source.averageNeighbourDistance), toBePruned(source.toBePruned) {
