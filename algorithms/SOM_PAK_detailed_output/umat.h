...
double median4 (double, double, double, double);
double median5 (double, double, double, double, double);
double median6 (double, double, double, double, double, double);
double median7 (double, double, double, double, double, double, double);
